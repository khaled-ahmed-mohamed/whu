        ...
        <div id="Home">
            <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                    ...
                    <img src={require("./images/banner1.webp")} className="d-block w-100" alt="lab1 1"/>
                    </div>
                    <div className="carousel-item">
                    <img src={require("./images/banner2.webp")} className="d-block w-100" alt="lab 2"/>
                    </div>
                    <div className="carousel-item">
                    <img src={require("./images/banner10.jpg")} className="d-block w-100" alt="lab 3"/>
                    </div>
                </div>
